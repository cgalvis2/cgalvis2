              ...
              return `
                <tr>
                  <td style="text-align: center; padding: 4px;">
                    <div style="width: 40px; height: 40px; background: #f3f4f6; border-radius: 4px; display: flex; align-items: center; justify-content: center; font-size: 8px; color: #6b7280; margin: 0 auto; background-image: url('${imageUrl || placeholderUrl}'); background-size: cover; background-position: center;">
                      ${isPlaceholder ? product.style : ""}
                    </div>
                  </td>
